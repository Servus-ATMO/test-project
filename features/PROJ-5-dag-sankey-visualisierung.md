...
**Hinweis:** Die live deployte Version (siehe Deployment-Abschnitt) enthält noch nicht das Graph-UI-Batch (per-Spalten-Sichtbarkeit, Persona-Filter, Ebene-2-Dimensionsgruppierung) — implementiert, aber noch nicht durch `/qa` gelaufen. Nächster Schritt: `/qa PROJ-5`.
